...
function formatUsageType(byok: boolean): string {
  return byok ? "BYOK" : "Historical credits";
}
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6 overflow-y-auto p-6">
        ...
        <DetailSection title="Tokens & estimated cost">
          ...
          <DetailRow label="Estimated cost" value={formatCost(response.pricing.cost)} mono />
        </DetailSection>

        <DetailSection title="Request">
          <DetailRow label="Usage type" value={formatUsageType(request.byok)} />
