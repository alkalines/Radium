...
export function ClaudeIcon() {
    return (
        <div className="relative inline-block align-middle pt-0.5 md:mr-3" style={{ opacity: 1, width: 'auto', transform: 'none' }}>
            <div style={{ opacity: 1 }}>
                <div className="transition-colors text-[#D97757] w-8 inline-block" style={{ position: 'relative' }}>
                    <svg
                        overflow="visible"
                        width="100%"
                        height="100%"
                    ...
                    >
                        ...
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(150deg) scaleY(1.05588) rotate(-150deg)',
                            }}
                        />
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(120deg) scaleY(1.04755) rotate(-120deg)',
                            }}
                        />
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(90deg) scaleY(1.17421) rotate(-90deg)',
                            }}
                        />
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(60deg) scaleY(1.17412) rotate(-60deg)',
                            }}
                        />
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(30deg) scaleY(1.13745) rotate(-30deg)',
                            }}
                        />
                        <path
                            ...
                            style={{
                                transformOrigin: '50px 50px',
                                transform: 'rotate(0deg) scaleY(1.05279) rotate(0deg)',
                            }}
                        />
                    </svg>
                </div>
