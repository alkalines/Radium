    ...
    <div className="flex flex-col px-2 pt-1 gap-px mb-6">
      ...
      <SidebarItem
        ...
        icon={
          ...
          >
            <path
              className="group-hover:scale-95 origin-center"
      ...
      <SidebarItem
        ...
        icon={
          <svg
            ...
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
            className="shrink-0 group backface-hidden"
            aria-hidden="true"
          >
            <path
              fillRule="evenodd"
            ...
            />
            <path
              className="group-hover:-rotate-90 transition-transform duration-200 ease-snappy-out"
            ...
            />
            <path
              className="group-hover:rotate-[120deg] transition-transform duration-200 ease-snappy-out"
              fillRule="evenodd"
              clipRule="evenodd"
