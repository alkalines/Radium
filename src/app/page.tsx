        ...
        <MainLayout>
            <main className="mx-auto mt-4 w-full flex-1 px-4 md:px-8 lg:mt-6 max-w-7xl !mt-0 flex flex-col items-center gap-8 md:px-14 3xl:px-20 pt-[10vh] md:pt-[20vh] max-sm:!px-1 bg-bg-100">
                ...
                <div className="mx-auto flex w-full flex-col items-center gap-7 max-md:pt-4 max-w-2xl">
                    ...
                    >
                        <ClaudeIcon />
                        <div className="inline-block max-w-full align-middle max-md:line-clamp-2 max-md:break-words md:overflow-hidden md:overflow-ellipsis select-none" style={{ opacity: 1 }}>
                            Oi Gabriel, tudo bem?
                        </div>
                    </div>
                </div>
